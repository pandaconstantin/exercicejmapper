...
public class StructureComptableComplexeDto implements Serializable {
    ...
    @JsonIgnore
    private StructureComptableDto structureComptableDto;
    @JsonIgnore
    public StructureComptableDto getStructureComptableRattachementForMapper() {
        if (structureComptableDto != null) {
            return structureComptableDto;
        } else {
            return new StructureComptableDto();
        }
    }
}